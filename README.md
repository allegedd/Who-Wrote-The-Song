...
他の音楽系のサブスクサービス等においても関連楽曲のレコメンドは存在しますが、作曲家、作詞家の関連作品にフォーカスしたレコメンドにはなっていません。  
作曲家、作詞家の関連楽曲にフォーカスした検索機能が本サービスの推しポイントになります。
...
- 提案した楽曲の Spotify へのリンク表示
- 検索入力時のオートコンプリート

## ■ 機能の実装方針予定

- 関連楽曲検索：MusicBrainz(Database or API)
- プレビュー：Yotube Data APIv3
- Spotify へのリンク：Spotify API
